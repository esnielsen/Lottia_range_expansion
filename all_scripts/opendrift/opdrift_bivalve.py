...
o.set_config('drift:max_age_seconds', 2592000) # maximum settlement age = 30 days
...
####### Seed elements from 4 Northern sites with seeding radius of 100m
...
o.plot(filename='Nsites_17.18.plot.pdf')
...
o.plot(fast=True, background=strand_density.where(strand_density>0),
        ...
        show_elements=False, linewidth=0, filename='Nsites_17.18.strand.dens.pdf')

# Write output as .tif
o.write_geotiff(filename='Nsites_17.18.dens.plot.tif', pixelsize_km=2)

# Write output as .nc with densities
o.write_netcdf_density_map(filename='Nsites_17.18.dens.nc', pixelsize_m=3000)
