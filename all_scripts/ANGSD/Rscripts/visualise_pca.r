...
#read info file
x_info<-read.table("/ocean/projects/deb200006p/enielsen/LGwork/02_info/info.txt", header=T)
pca.mat<-read.table(paste0("/ocean/projects/deb200006p/enielsen/LGwork/angsd/04_pca/all_maf0.05_pctind0.5_maxdepth30.cov.pca"), header=T)
...
pdf(file=paste0("/ocean/projects/deb200006p/enielsen/LGwork/angsd/04_pca/all_maf",MIN_MAF,"_pctind",PERCENT_IND,".pca.",group_name,".pdf"))
par(mfrow=c(1,2))
