...
path2models=\"/ocean/projects/deb200006p/enielsen/LGwork/Moments/AFS-analysis-with-moments/multimodel_inference/\"   path to the cloned repository
...
if(length(path2models)>0) { path2models=sub("path2models=","", commandArgs()[path2models]) } else { path2models="/ocean/projects/deb200006p/enielsen/LGwork/Moments/AFS-analysis-with-moments/multimodel_inference/" }
